...
const ExtensionPopup: React.FC = () => {
      ...
      ? [
          {
            ...
            placeholder:
              'Major water privatization and BDS violations in occupied territories',
            links: [
              {
  ...
  const displayBrands =
    visibleDetectedBrands.length > 0 ? visibleDetectedBrands : testBrands;
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    Continuously monitor for brands
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className={`h-8 px-3 text-xs flex-shrink-0 ${
                    isHighlighting
                      ? 'text-white'
                      : 'text-gray-200 border-gray-600 hover:text-white hover:bg-gray-700'
                  }`}
                >
            ...
            {displayBrands.length === 0 ? (
              ...
              <div className="space-y-2">
                {displayBrands.map((brand, index) => (
                  <div
                    key={index}
                    className="p-3 rounded-lg border border-red-800/30 bg-red-900/10"
                  >
